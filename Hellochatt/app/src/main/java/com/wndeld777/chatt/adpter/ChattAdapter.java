package com.wndeld777.chatt.adpter;
...
public class ChattAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void addChatList(Chatt chatt){
        ...
        // RecyclerView 에게 chattList 가 변화 되었으니 다시 화면에 그려라
        // chattList 의 끝(size() - 1 위치에 값이 추가 되었으니)에
        // 값이 추가 되었으니 다시 그려라
        notifyItemInserted(chattList.size() - 1);
    }

    /**
     * RecyclerView 가 화면에 그린 데이터들을 전달받을 통로
     * @param chattList
     */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
         ...
         * 여기에서는 RecyclerView 내부에 각각의 데이터 아이템을 그릴 도구로 사용이 된다
    ...
    public static class ChattViewHolder extends RecyclerView.ViewHolder{
        ...
        // 각 데이터를 표현하기 위한 chat_item.xml 의 view 객체(두개의 TextView)를 초기화(생성) 하는 method
